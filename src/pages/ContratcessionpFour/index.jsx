                                    ...
                                    <div className="flex flex-col items-center justify-start w-[48%]">
                                      <div className="flex flex-col items-center justify-start w-full">
                                        <SelectBox
                                          ...
                                          options={
                                            relationclientSevenOptionsList
                                          }
                                          isSearchable={false}
                                  ...
                                  <div className="flex flex-col items-center justify-start w-[43%]">
                                    <div className="flex flex-col items-center justify-start w-full">
                                      <SelectBox
                                        ...
                                        options={relationclientEightOptionsList}
                                        isSearchable={false}
                                        placeholder="OUI"
                                      />
                                    </div>
                                  ...
                                  <div className="flex flex-col items-center justify-start w-[48%]">
                                    <div className="flex flex-col items-center justify-start w-full">
                                      <SelectBox
                                        ...
                                        options={relationclientNineOptionsList}
                                        isSearchable={false}
                                        placeholder="NON"
                                      />
                                    </div>
...
export default ContratcessionpFourPage;
