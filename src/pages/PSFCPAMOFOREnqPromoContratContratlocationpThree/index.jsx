...
const PSFCPAMOFOREnqPromoContratContratlocationpThreePage = () => {
  const sideBarMenu = [
    {
      label:
              ...
              <div className="flex flex-col h-full items-center justify-start w-full">
                <div className="flex flex-col gap-2.5 h-full items-start justify-start w-full">
                  ...
                  <div className="bg-white-A700 flex flex-col gap-2.5 items-center justify-start p-2.5 w-full">
                    ...
                    <ContratdonationPThreeColumnentresoussigns className="flex flex-col items-center justify-start pt-[3px] w-full" />
                  </div>
                </div>
              </div>
            </div>
...
export default PSFCPAMOFOREnqPromoContratContratlocationpThreePage;
