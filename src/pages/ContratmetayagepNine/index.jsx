...
const ContratmetayagepNinePage = () => {
                            ...
                            <div className="flex flex-col items-center justify-start max-w-[790px] p-2.5 w-full">
                              ...
                              <div className="flex flex-col items-start justify-center w-auto md:w-full">
                                <div className="flex flex-col items-center justify-start w-full">
                                  ...
                                  >
                                    Le présent contrat est établi en 3
                                    exemplaires originaux destinés au détenteur
                                    du droit foncier, au métayer et au CVGFR.
                                  </Text>
                                </div>
                                <List
...
export default ContratmetayagepNinePage;
