...
const PSFCPAMOFOREnqPromoContratContratlocationpSixPage = () => {
                                ...
                                <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col items-start justify-center max-w-[770px] px-[18px] py-[5px] rounded-sm w-full">
                                  ...
                                  >
                                    <>
                                      ...
                                      <br />
                                      <br />
                                      Le locataire déclare sur l’honneur :
                                      <br />
                                      Que les informations sur son identité
                                      renseignées sur ce contrat sont justes et
                                      sincères.
                                ...
                                <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col h-[130px] md:h-auto items-start justify-center max-w-[770px] px-[18px] py-[5px] rounded-sm w-full">
                                  ...
                                  >
                                    <>
                                      ...
                                      locataire et devront respecter le présent
                                      contrat.
                                      <br />
                                      En cas de décès du locataire, ses
                                      héritiers bénéficieront du contrat à la
                                      place du défunt dans les mêmes conditions
                                      ou pourront demander la rupture du
                                      contrat.
                                      <br />
                                      Si le détenteur du droit foncier vend ou
                                      donne la terre qu’il a mise à la
                                      disposition du locataire, l&#39;acquéreur
                                      ne peut expulser le locataire. Le contrat
                                      entre le locataire et le détenteur initial
                                      du droit foncier est reconduit entre le
                                      locataire et l’acquéreur, dans les termes
                                      en vigueur au moment de la vente ou du
                                      don.
                                      <br />
                                      Le locataire ne pourra céder son droit
                                      résultant du présent contrat qu’avec
                                      l’accord exprès du détenteur du droit
                                      foncier. Pour être valable, toute cession
                                      de ses droits au présent contrat doit être
                                      passée et constatée par écrit.
                                      <br />
                                      <br />
                              ...
                              <div className="flex flex-col items-center justify-start w-full">
                                <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col items-start justify-center max-w-[770px] px-[18px] py-[5px] rounded-sm w-full">
                                  ...
                                  >
                                    ...
                                    disposition du locataire le terrain objet du
                                    présent contrat que le locataire accepte
...
export default PSFCPAMOFOREnqPromoContratContratlocationpSixPage;
