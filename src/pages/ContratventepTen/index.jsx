...
import ContratdonationPTwoColumnentresoussigns from "components/ContratdonationPTwoColumnentresoussigns";
              ...
              <div className="flex flex-col h-full items-center justify-start w-full">
                <div className="flex flex-col gap-2.5 h-full items-start justify-start w-full">
                  ...
                  <div className="bg-white-A700 flex flex-col gap-2.5 items-center justify-start p-2.5 w-full">
                    ...
                    <ContratdonationPTwoColumnentresoussigns
                      className="flex flex-col gap-[5px] items-center justify-start w-full"
                      description={
                        <Text className="font-medium leading-[20.00px] max-w-[370px] md:max-w-full text-black-900 text-xs">
                          ...
                          <span className="text-black-900 font-inter text-left text-[10px] font-normal">
                            ...
                            représentant du groupement informel et lister
                            l’ensemble des détenteurs de droits sur la parcelle
                            avec leur signature ou empreinte.)
                          </span>
                        </Text>
                      }
                      rgion="Nom du groupement"
                      rgionOne="Nombre de personnes du groupement"
                      ciaprsdnomm="Ci-après dénommé « l’acheteur »"
                    />
                    <div className="bg-blue_gray-100 h-[17px] w-[4%]"></div>
                  </div>
                </div>
              </div>
            </div>
...
export default ContratventepTenPage;
