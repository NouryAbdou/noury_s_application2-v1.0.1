...
const personneMoraleOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];
                ...
                <div className="flex flex-col gap-2.5 h-full items-start justify-start w-full">
                  ...
                  <div className="bg-white-A700 flex flex-col gap-2.5 items-center justify-start p-2.5 w-full">
                    ...
                    <ContratdonationPThreeColumnentresoussigns
                      className="flex flex-col items-center justify-start py-[3px] w-full"
                      nometprnoms="Dénomination"
                      languageTwo="N° d’enregistrement"
                      nometprnomsOne="Nom et prénom(s) du représentant"
...
export default ContratventepNinePage;
