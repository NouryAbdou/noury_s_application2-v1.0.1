...
const PSFCPAMOFOREnqPromoContratContratlocationpEightPage = () => {
                                ...
                                <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col items-start justify-center max-w-[744px] px-[18px] py-[5px] rounded-sm w-full">
                                  ...
                                  >
                                    <>
                                      ...
                                      <br />
                                      Le locataire peut demander la rupture du
                                      ...
                                      d’une juste compensation fixée d’accord
                                      partie ou par une juridiction compétente.
                                    </>
                                  </Text>
                                </div>
                              </div>
...
export default PSFCPAMOFOREnqPromoContratContratlocationpEightPage;
