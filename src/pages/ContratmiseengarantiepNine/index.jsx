...
const ContratmiseengarantiepNinePage = () => {
    ...
    <>
      ...
      >
        ...
        <div className="flex md:flex-col flex-row md:gap-5 h-[831px] md:h-auto items-start justify-start max-w-[1440px] mt-[5px] w-full">
          <Sidebar6 className="!sticky !w-[263px] bg-cyan-900_19 flex h-screen md:hidden justify-start overflow-auto md:px-5 rounded-sm top-[0]" />
...
export default ContratmiseengarantiepNinePage;
