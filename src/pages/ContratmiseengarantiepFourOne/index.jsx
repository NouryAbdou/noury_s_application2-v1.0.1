...
const ContratmiseengarantiepFourOnePage = () => {
  return (
    <>
      <div
                      ...
                      description={
                        <Text className="font-medium leading-[20.00px] max-w-[370px] md:max-w-full text-black-900 text-xs">
                          ...
                          <span className="text-black-900 font-inter text-left text-[10px] font-normal">
                            ...
                            représentant de la famille et lister l’ensemble des
                            détenteurs de droits sur la parcelle avec leur
                            signature ou empreinte.)
                          </span>
                        </Text>
                      }
                      ciaprsdnomm="Ci-après dénommé « le détenteur du droit foncier » et,"
                    />
                  </div>
                </div>
              </div>
...
export default ContratmiseengarantiepFourOnePage;
