...
const PSFCPAMOFOREnqPromoContratContratlocationpNinePage = () => {
    ...
    <>
      ...
      >
        ...
        <div className="flex md:flex-col flex-row md:gap-5 h-[1124px] md:h-auto items-start justify-start max-w-[1440px] mt-[5px] w-full">
          <Sidebar2 className="!sticky !w-[273px] flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]" />
                                ...
                                <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col items-start justify-center max-w-[744px] px-[18px] py-[5px] rounded-sm w-full">
                                  ...
                                  >
                                    <>
                                      ...
                                      du présent contrat ;
                                      <br />
                                      Informer le locataire en cas de donation
                                      de la terre ;
                                      <br />
                                      Informer prioritairement le locataire en
                                ...
                                <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col items-start justify-center max-w-[744px] px-[18px] py-[5px] rounded-sm w-full">
                                  ...
                                  >
                                    <>
                                      ...
                                      vue d&#39;obtenir une réduction du loyer,
...
export default PSFCPAMOFOREnqPromoContratContratlocationpNinePage;
