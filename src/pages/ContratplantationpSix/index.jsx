...
const ContratplantationpSixPage = () => {
              ...
              <div className="flex flex-col h-[1011px] md:h-auto items-center justify-start w-full">
                <div className="flex flex-col gap-2.5 h-full items-start justify-start w-full">
                  ...
                  <div className="bg-white-A700 flex flex-col gap-2.5 h-[926px] md:h-auto items-center justify-start p-2.5 w-full">
                    <div className="flex flex-col h-[770px] md:h-auto items-center justify-start w-full">
                      <div className="flex flex-col h-[687px] md:h-auto items-start justify-center max-w-[770px] w-full">
                                  ...
                                  <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col h-[130px] md:h-auto items-start justify-center max-w-[770px] px-[18px] py-[5px] rounded-sm w-full">
                                    ...
                                    >
                                      <>
                                        ...
                                        attendu ou si sa décision est
                                        contestée.En dernier recours, saisie du
                                        Tribunal compétent si le Préfet n’a pas
                                        tranché le litige dans les délais ou si
                                        sa décision est contestée.
                                      </>
                                    </Text>
                                  </div>
                                </div>
                                  ...
                                  <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col h-[71px] md:h-auto items-start justify-center max-w-[769px] px-[18px] py-[5px] rounded-sm w-full">
                                    ...
                                    >
                                      <>
                                        ...
                                        et l’entretien d’une plantation. En
                                        contrepartie du présent contrat, le
                                        planteur accepte de partager la
                                        plantation avec le détenteur du droit
                                        foncier.
                                        <br />
                                        Le terrain demeure la propriété du
                                        détenteur du droit foncier pendant et
                                        après l’exécution du présent contrat.
                                      </>
                                    </Text>
                                  </div>
                                </div>
                                <div className="flex flex-col items-center justify-start w-[99%] md:w-full">
                                  <div className="flex flex-col h-48 md:h-auto items-center justify-start max-w-[762px] w-full">
                                    ...
                                    <div className="flex flex-col items-center justify-start w-full">
                                      <div className="flex flex-col h-[168px] md:h-auto items-start justify-center max-w-[762px] w-full">
                                        <div className="flex flex-col items-center justify-start w-full">
                                          <div className="flex flex-col gap-4 h-[111px] md:h-auto items-start justify-start max-w-[762px] w-full">
                                            <div className="flex sm:flex-col flex-row gap-4 h-[31px] md:h-auto items-center justify-start w-[521px] sm:w-full">
                                            ...
                                            <div className="flex flex-col items-center justify-start w-full">
                                              ...
                                              >
                                                <>
                                                  ...
                                                  par les 2 parties. 
                                                  <br />
                                                  Cette durée est modifiable
                                                  d’un commun accord des parties
                                                  par avenant au présent
                                                  contrat.
                                                  <br />
                                                  Le contrat prend fin si le
                                                  planteur cesse d’exploiter la
                                                  plantation ou si elle tombe en
                                                  jachère ; le détenteur du
                                                  droit foncier dispose alors
                                                  librement de la totalité du
                                                  terrain.
                                                  <br />
                                                  Au terme du contrat, les
                                                  parties établissent un nouveau
                                                  contrat. 
                                                </>
                                              </Text>
                                            </div>
...
export default ContratplantationpSixPage;
