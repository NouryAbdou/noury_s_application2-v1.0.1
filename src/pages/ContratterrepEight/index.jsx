...
const ContratterrepEightPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div
        className="bg-cover bg-no-repeat bg-white-A700 flex flex-col font-inter h-[1445px] items-center justify-start mx-auto pb-2.5 w-full"
      ...
      >
        ...
        <div className="flex md:flex-col flex-row md:gap-5 h-[1366px] md:h-auto items-start justify-start max-w-[1440px] mt-[5px] w-full">
                    ...
                    <div className="flex flex-col gap-[26px] h-[1227px] md:h-auto items-center justify-start max-w-[926px] w-full">
                      <div className="flex flex-col gap-[26px] items-start justify-start w-[89%] md:w-full">
                        ...
                        <div className="flex flex-col items-start justify-start w-full">
                          <div className="flex flex-col items-center justify-start w-[92%] md:w-full">
                            <div className="flex flex-col items-center justify-start w-full">
                              <div className="flex flex-col items-start justify-start max-w-[744px] w-full">
                                ...
                                ></Input>
                                <div className="flex flex-col items-center justify-start w-full">
                                  <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col h-[94px] md:h-auto items-start justify-center max-w-[744px] px-[18px] py-[5px] rounded-sm w-full">
                                    <Text
                                      className="leading-[20.00px] text-black-900 text-xs"
                                      size="txtInterRegular12Black900"
                                    >
                          ...
                          <div className="flex flex-col h-[111px] md:h-auto items-center justify-center max-w-[744px] mt-4 w-full">
                          ...
                          <div className="flex flex-col gap-[26px] h-[486px] md:h-auto items-start justify-center max-w-[813px] md:ml-[0] ml-[3px] mt-3 w-full">
                            <Text
                              className="leading-[20.00px] text-black-900 text-xs"
                              size="txtInterRegular12Black900"
                            >
                            ...
                            <div className="flex flex-col gap-[26px] items-start justify-start w-full">
                              ...
                              <CheckBox
                                ...
                                size="md"
                              ></CheckBox>
                              <div className="flex flex-col gap-3.5 items-start justify-start w-[84%] md:w-full">
...
export default ContratterrepEightPage;
