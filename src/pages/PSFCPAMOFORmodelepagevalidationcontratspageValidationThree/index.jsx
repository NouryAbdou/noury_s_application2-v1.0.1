...
const PSFCPAMOFORmodelepagevalidationcontratspageValidationThreePage = () => {
  return (
    <>
      <div
      ...
      >
        <div className="flex md:flex-col flex-row md:gap-5 h-[900px] md:h-auto items-start justify-start max-w-[1440px] w-full">
          <Sidebar className="!sticky !w-10 bg-white-A700_ab flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]"></Sidebar>
            ...
            <div className="flex md:flex-col flex-row md:gap-5 h-full items-start justify-start p-2.5 w-full">
              <div className="flex flex-1 flex-col h-full items-center justify-start pr-5 py-[30px] w-full">
                <div className="flex flex-col h-[786px] md:h-auto items-start justify-start w-full">
                  <div className="bg-white-A700 flex flex-col h-[786px] md:h-auto items-start justify-start">
                    <div className="bg-white-A700 flex flex-col gap-2.5 h-[786px] md:h-auto items-center justify-start max-w-[914px] p-2.5 w-full">
                      <Img
                      ...
                      <div className="flex flex-col gap-[15px] h-[661px] md:h-auto items-center justify-start w-full">
                        <div className="flex flex-col gap-[15px] items-center justify-start w-[42%] md:w-full">
...
export default PSFCPAMOFORmodelepagevalidationcontratspageValidationThreePage;
