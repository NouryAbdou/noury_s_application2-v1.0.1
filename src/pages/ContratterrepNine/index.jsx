                            ...
                            <div className="flex flex-col items-center justify-start max-w-[744px] w-full">
                              ...
                              <div className="flex flex-col items-center justify-start w-full">
                                <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col gap-2 items-start justify-center max-w-[744px] px-[18px] py-[5px] rounded-sm w-full">
                                  ...
                                  >
                                    <>
                                      Les installations effectuées sur la terre
                                      par le planteur pour la création et
                                      l’entretien de la plantation restent sa
                                      propriété. Il peut céder au détenteur du
                                      droit foncier les installations se
                                      trouvant sur la terre restant la propriété
                                      de ce dernier à un prix qui sera fixé
                                      entre les parties à l’expiration du
                                      présent contrat lorsqu’il s’agit
                                      d’installations fixes et non déplaçables.
                                      <br />
                                      Le détenteur du droit foncier dispose d’un
                                      droit de surveillance et de contrôle des
                                      travaux de création de la plantation et
                                      d’un droit d’information de la part du
                                      planteur sur les activités qu’il envisage
                                      de réaliser, qu’il réalise ou qu’il a
                                      réalisées.
                                    </>
                                  </Text>
...
export default ContratterrepNinePage;
