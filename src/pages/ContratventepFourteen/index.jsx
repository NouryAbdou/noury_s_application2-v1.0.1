...
const ContratventepFourteenPage = () => {
                              ...
                              <div className="flex flex-col items-start justify-center w-auto md:w-full">
                                <div className="flex flex-col items-center justify-start w-full">
                                  ...
                                  >
                                    ...
                                    exemplaires originaux destinés au vendeur et
                                    à l’acheteur. Une copie est destinée au
                                    CVGFR.
                                  </Text>
                                </div>
                                <div className="flex sm:flex-col flex-row gap-2.5 h-[85px] md:h-auto items-start justify-start w-auto sm:w-full">
                                  <div className="flex flex-col items-start justify-start w-[49%] sm:w-full">
                                    ...
                                    <div className="flex flex-col items-center justify-start mt-[3px] w-full">
                                      <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col items-start justify-center px-[18px] py-[5px] rounded-md w-[229px]">
                                        <div className="flex flex-col h-[23px] md:h-auto items-center justify-start w-full">
                                          <Text
...
export default ContratventepFourteenPage;
