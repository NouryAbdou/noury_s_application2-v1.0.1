...
const ContratterrepSevenPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div
        className="bg-cover bg-no-repeat bg-white-A700 flex flex-col font-inter h-[1281px] items-center justify-start mx-auto pb-0.5 w-full"
      ...
      >
        ...
        <div className="flex md:flex-col flex-row md:gap-5 h-[1210px] md:h-auto items-start justify-start max-w-[1440px] mt-[5px] w-full">
          <Sidebar className="!sticky !w-[263px] bg-white-A700 flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]">
            <Button
              className="common-pointer cursor-pointer leading-[normal] mb-[1145px] mt-2.5 mx-auto rounded-sm text-center text-xs w-[223px]"
            ...
            <Button
              className="common-pointer cursor-pointer leading-[normal] mb-[1095px] mt-[75px] mx-auto rounded-sm text-center text-xs w-[223px]"
              onClick={() => navigate("/contrats")}
              color="cyan_900_19"
              size="sm"
              variant="fill"
            ...
            <Button
              className="common-pointer cursor-pointer leading-[normal] mb-[1030px] mt-[125px] mx-auto rounded-sm text-center text-xs w-[223px]"
              onClick={() => navigate("/contrats")}
              color="cyan_900_19"
              size="sm"
              variant="fill"
            ...
            <Button
              className="common-pointer cursor-pointer leading-[normal] mb-[980px] mt-[190px] mx-auto rounded-sm text-center text-xs w-[223px]"
              onClick={() => navigate("/contrats")}
              color="cyan_900_19"
              size="sm"
              variant="fill"
            ...
            <Button
              className="common-pointer cursor-pointer leading-[normal] mb-[945px] mt-60 mx-auto rounded-sm text-center text-xs w-[223px]"
              onClick={() => navigate("/contrats")}
              color="cyan_900_19"
              size="sm"
              variant="fill"
            ...
            <Button
              className="common-pointer cursor-pointer leading-[normal] mb-[895px] mt-[275px] mx-auto rounded-sm text-center text-xs w-[223px]"
              onClick={() => navigate("/contrats")}
              color="cyan_900_19"
              size="sm"
              variant="fill"
            ...
            <Button
              className="common-pointer !text-white-A700 cursor-pointer leading-[normal] mb-[845px] mt-[325px] mx-auto rounded-sm text-center text-xs w-[223px]"
              onClick={() => navigate("/contrats")}
              color="cyan_900_19"
              size="sm"
              variant="fill"
            ...
            <Button
              className="common-pointer cursor-pointer leading-[normal] mb-[795px] mt-[375px] mx-auto rounded-sm text-center text-xs w-[223px]"
              onClick={() => navigate("/contrats")}
              color="cyan_900_19"
              size="sm"
              variant="fill"
              ...
              <div className="flex flex-col h-full items-center justify-start w-full">
                <div className="flex flex-col gap-2.5 h-full items-start justify-start w-full">
                  ...
                  <div className="bg-white-A700 flex flex-col h-[1105px] md:h-auto items-center justify-start p-2.5 w-full">
                    <div className="flex flex-col h-[962px] md:h-auto items-start justify-center max-w-[802px] w-full">
                      <div className="flex flex-col h-[918px] md:h-auto items-center justify-start max-w-[802px] w-full">
                        <div className="flex flex-col md:gap-10 gap-[97px] items-center justify-start max-w-[802px] w-full">
                          <div className="md:h-[343px] h-[599px] relative w-[98%] md:w-full">
                            ...
                            <div className="absolute bottom-[0] flex flex-col inset-x-[0] mx-auto w-[774px] md:w-full">
                              <div className="flex flex-col gap-[9px] h-[210px] md:h-auto items-center justify-center max-w-[774px] mx-auto w-full">
                              ...
                              <CheckBox
                                className="mt-[-15.55px] mx-auto z-[1]"
                                inputClassName="border border-gray-300 border-solid h-[74px] mr-[5px] w-[74px] z-[1]"
...
export default ContratterrepSevenPage;
