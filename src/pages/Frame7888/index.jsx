...
const Frame7888Page = () => {
  ...
  return (
    <>
      <div className="flex flex-col font-inter items-start justify-start mx-auto sm:px-5 px-[30px] w-auto sm:w-full md:w-full">
        <div className="flex flex-col h-full items-start justify-start max-w-[1059px] mx-auto md:px-5 py-2.5 w-full">
          <div className="flex flex-col h-full items-center justify-start w-full">
            <div className="flex flex-col gap-2.5 h-full items-start justify-start w-full">
              ...
              <div className="bg-white-A700 flex flex-col gap-2.5 items-center justify-start p-2.5 w-full">
                ...
                />
                <Text
                  className="text-base text-black-900 text-center w-[145px]"
